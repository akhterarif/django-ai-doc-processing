"""
Django settings for django_ai_doc_processing project.
...
SECRET_KEY = 'django-insecure-16e+jpezr4h_%bj6$$v9egp5s+lhlxxwfqicx6ri@tbjk)m&^-'
...
ROOT_URLCONF = 'django_ai_doc_processing.urls'
...
WSGI_APPLICATION = 'django_ai_doc_processing.wsgi.application'
...
# Specify required roles for specific API endpoints
